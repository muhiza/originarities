...
class Article(models.Model):
    ...
    author = models.ForeignKey(
        User,
        help_text="The user writing the content.",
    )
    category = models.ForeignKey(
        Category,
        help_text="The category of the content.",
    )
    ...
    body = models.TextField(help_text="The body of the content [in Markdown].")
    image = models.ForeignKey(
        Image,
        blank=True,
        null=True,
        help_text="An image highlighting the contents of the file.",
    ...
    status = models.PositiveSmallIntegerField(
        choices=STATUS,
        default=DRAFT,
        help_text="The current status of the content.",
    )
    cc_license = models.BooleanField(
        default=True,
        help_text="Whether the content is released under the CC-BY-SA 4.0 license or not.",
    )
...
class ScheduledArticle(models.Model):
    ...
    date = models.DateTimeField(help_text="Date/time to publish content (YYYY-MM-DD HH:MM:SS).")
